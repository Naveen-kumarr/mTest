        ...
        return (
            <div className="container-fluid mt-3">
                ...
                <div className="row mt-5">
                    ...
                    <p className="mt-4">Simplified protocols for authorities to issue tamperproof certificates</p>
                    </center>
                    </div>
                    <div className="col-md-2">
                    <center>
                    <img src ={Holdinghands} style={{height:"70px",width:"70px"}}/>
                    <p className="mt-4">Providing ownership of certificate data without depending on intermediaries.Ability to share certificates with other parties</p>
                    </center>
                    </div>
                    <div className="col-md-2">
                    <center>
                    <img src ={Hands} style={{height:"70px",width:"70px"}}/>
                    <p className="mt-4">Open for all consumer mechanism to verify certificates</p>
                    </center>
                    </div>
                    <div className="col-md-2">
                    <center>
                    <img src ={Community} style={{height:"70px",width:"70px"}}/>
                    <p className="mt-4">Secure & immutable way to store and share valued certification data</p>
                    </center>
                    </div>
                    <div className="col-md-2">
                    <center>
                    <img src ={Mind} style={{height:"70px",width:"70px"}}/>
                    <p className="mt-4">Identify & discourage counterfeiting in real-time.</p>
                    </center>
                    </div>
                    <div className="col-1">
